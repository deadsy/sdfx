	...
	tests := []struct {
	...
	}{
		{
			...
			specs: Specs{
				...
				PathLogFea:             filepath.Join(os.TempDir(), "bms-FEA-log.txt"),
				MassDensity:            7.85e-9,
				YoungModulus:           210000,
				PoissonRatio:           0.3,
				GravityDirectionX:      0,
		...
		},
		{
			...
			specs: Specs{
				...
				PathLogFea:             filepath.Join(os.TempDir(), "bmc-FEA-log.txt"),
				MassDensity:            7.85e-9,
				YoungModulus:           210000,
				PoissonRatio:           0.3,
				GravityDirectionX:      0,
		...
		},
		{
			...
			specs: Specs{
				...
				PathLogFea:             filepath.Join(os.TempDir(), "bmp-FEA-log.txt"),
				MassDensity:            7.85e-9,
				YoungModulus:           210000,
				PoissonRatio:           0.3,
				GravityDirectionX:      0,
		...
		},
		{
			...
			specs: Specs{
				...
				PathLogFea:             filepath.Join(os.TempDir(), "bmi-FEA-log.txt"),
				MassDensity:            7.85e-9,
				YoungModulus:           210000,
				PoissonRatio:           0.3,
				GravityDirectionX:      0,
