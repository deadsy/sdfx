	...
	tests := []struct {
	...
	}{
		{
			...
			specs: Specs{
				...
				Resolution:                     50,
				LayerByLayerfor3dPrintAnalysis: false,
				LayerByLayerPathResult:         "",
		...
		},
		{
			...
			specs: Specs{
				...
				GravityMagnitude:               9810,
				Resolution:                     50,
				LayerByLayerfor3dPrintAnalysis: true,
				LayerByLayerPathResult:         filepath.Join(os.TempDir(), "teapot-result-layer0-to-layer#.inp"),
				NonlinearConsidered:            false,
				ExactSurfaceConsidered:         true,
			},
			loads: []Load{
